...
stargazer(AUCsvm, summary=FALSE, title='SVM pair-wise AUC')
stargazer(AUCtree, summary=FALSE, title='Tree pair-wise AUC')
stargazer(AUClda, summary=FALSE, title='LDA pair-wise AUC')
```
