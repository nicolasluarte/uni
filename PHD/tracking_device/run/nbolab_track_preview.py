...
parserArg.add_argument(
    "--capture", type=int, help="set the camera stream vide0 as default"
)
...
if args.background is not None:
    ...
    bg = cv2.imread(
        "/home/pi/uni/PHD/tracking_device/background/bg.png", cv2.IMREAD_GRAYSCALE
    )
...
stream = PiGear(
    resolution=(320, 240), framerate=60, colorspace="COLOR_BGR2GRAY"
).start()
